	...
	{	
		...
		return this.each(function(){
			...
			function flip()
			{
				...
				if (FlipCard.browser.IsIE10)
				{
					resetFrontBackElementClass(flippedClass, lastFlippedClass, transDir);
				...
				else
				{
					...
					else
					{
						...
						if (lastFlippedDir.direction !== flipOptions.direction)
						{
			...
			function resetFrontBackElementClass(flippedClass, lastFlippedClass, transDir)
			{
				...
				if (flipOptions.direction === FlipCard.direction.LR || flipOptions.direction === FlipCard.direction.RL)
				{
					...
					if (flipOptions.direction === FlipCard.direction.LR)
					{
						backEl.removeClass(FlipCard.classes.BACK_X);
				...
				else
				{
					...
					if (flipOptions.direction === FlipCard.direction.TB)
					{
						backEl.removeClass(FlipCard.classes.BACK_Y);
						backEl.removeClass(FlipCard.classes.BACK_Y_R);
						backEl.removeClass(FlipCard.classes.BACK_X_R);
